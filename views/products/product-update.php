...
<body>
    ...
    <div class="container py-5">
       <?php
        ...
        $old_data = !empty($_SESSION['old_data']) ? $_SESSION['old_data'] : $current_product;
        ...
        <div class="row">
            <div class="col-lg-8 mx-auto">
                ...
                <form action="<?= BASE_URL ?>handeler/products/editProducts.php" method="post" enctype="multipart/form-data" class="border rounded p-4 shadow-sm bg-white">
                   ...
                   <!-- Image -->
                    <div class="mb-3">
                        ...
                        <?php if (!empty($old_data['image'])): ?>
                            <div class="mb-2">
                                <img src="<?= BASE_URL . 'uploads/products/' . $old_data['image'] ?>" alt="Current Product Image" class="img-thumbnail shadow-sm" style="max-width: 120px; max-height: 120px; object-fit: cover;">
